	...
	public static String checkErrorTerm(String input) {
		...
		while (running) {
			...
			case 0: 
				...
				//if current character is a zero then move to state 8.
...
//				}
			...
			case 3:
				// State 3 has two valid transitions.  It is addressed by an if statement.
				...
				//If the current character is 0 then go to state 3
				else if(currentChar == '0') {
					nextState = 3;
					break;
				}
			...
			case 4: 
				// State 4 has one valid transition.  Each is addressed by an if statement.
			...
			case 8:
				// State 8 has only one valid transaction.
				
				//This is not final state
				finalState = false;
			...
			case 9:
				// State 9 has two valid transactions.
