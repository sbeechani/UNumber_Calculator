...
public class FloatingPointRecognizer {
	 ...
	 * @version 1.00		2018-02-15 Implemented the cases 5,6 and 7 in switch statement of FSM
	 * 								   Added + or - state to the FSM as state 8 and case 8
	 * 
	 */
	...
	public static String checkMeasureValue(String input) {
		...
		while (running) {
			...
			case 5: 
				...
				// If the current character is in the range from 0-9, it transitions to state 7
				if (currentChar >= '0' && currentChar <= '9') {
					nextState = 7;
					break;
				}
			...
			case 8:
				// State 8 has three valid transitions.  Each is addressed by an if statement.
		...
		case 0:
			...
			measuredValueIndexofError = currentCharNdx;		// Copy the index of the current character;
			measuredValueErrorMessage = "The first character must be a digit or a decimal point or a sign.";
			return "The first character must be a digit or a decimal point or a sign.";
		...
		case 8:
			...
			measuredValueIndexofError = currentCharNdx;		// Copy the index of the current character;
			measuredValueErrorMessage = "This character must be a digit or a decimal point.";
			return "This character must be a digit or a decimal point.";
